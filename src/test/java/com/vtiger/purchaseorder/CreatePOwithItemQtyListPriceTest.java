...
import com.vtiger.objectRepository.PurchaseOrderClass;
 
public class CreatePOwithItemQtyListPriceTest extends BaseClass {
	@Test
	public void createPOwithItemQtyListPriceTest() throws Throwable
	{
//		wUtil.waitForPageLoad(driver);
		HomeClass hc=new HomeClass(driver);
		PurchaseOrderClass poc = new PurchaseOrderClass(driver);
		hc.clickOnMore();
		hc.clickOnPOLink();
...
//		rntb.sendKeys(eUtil.excelUtility("PO", 4, 1)+ JavaUtility.generateRandomNumber());
		poc.getRntb().sendKeys(eUtil.excelUtility("PO", 4, 1)+ JavaUtility.generateRandomNumber());
...
//		salesComm.sendKeys(eUtil.sendNumericCellValue("PO", 7, 1));
		poc.getSalesComm().sendKeys(eUtil.sendNumericCellValue("PO", 7, 1));
...
//		WebElement status=driver.findElement(By.name("postatus"));
		WebElement status=poc.getStatus();
...
//		qty.sendKeys(eUtil.sendNumericCellValue("PO", 23, 1));
		poc.getQty().sendKeys(eUtil.sendNumericCellValue("PO", 23, 1));
		
		Thread.sleep(1000);
//		WebElement listPrice=driver.findElement(By.id("listPrice1"));
//		listPrice.sendKeys(eUtil.sendNumericCellValue("PO", 24, 1));
		poc.getListPrice().sendKeys(eUtil.sendNumericCellValue("PO", 24, 1));
